...
class BinaryUtilsTests: XCTestCase {
    ...
    func testConvert() {
        var int16: Int16 = 123
        let copy_int16 = int16
        let convertedInt16: Int16 = withUnsafeMutablePointer(to: &int16) {
            $0.withMemoryRebound(to: Int8.self, capacity: MemoryLayout.size(ofValue: copy_int16)) { value in
        ...
        let copy_int32 = int32
        let convertedInt32: Int32 = withUnsafeMutablePointer(to: &int32) {
            $0.withMemoryRebound(to: Int8.self, capacity: MemoryLayout.size(ofValue: copy_int32)) { value in
                return BinaryUtils.convert(value)
            }
        }
        ...
        let copy_uint64 = uint64
        let convertedUInt64: UInt64 = withUnsafeMutablePointer(to: &uint64) {
            $0.withMemoryRebound(to: Int8.self, capacity: MemoryLayout.size(ofValue: copy_uint64)) { value in
                return BinaryUtils.convert(value)
            }
        }
        ...
        let copy_double = double
        let convertedDouble: Double = withUnsafeMutablePointer(to: &double) {
            $0.withMemoryRebound(to: Int8.self, capacity: MemoryLayout.size(ofValue: copy_double)) { value in
                return BinaryUtils.convert(value)
            }
        }
        ...
        let convertedUUID: uuid_t = withUnsafeMutablePointer(to: &uuid) {
            $0.withMemoryRebound(to: Int8.self, capacity: MemoryLayout.size(ofValue: copy_uuid)) { value in
                return BinaryUtils.convert(value)
            }
        }
    ...
    func testParseInt16() {
        ...
        for int in testInts {
            ...
            let convertedInt: Int16 = withUnsafeMutablePointer(to: &bigEndian) {
                $0.withMemoryRebound(to: Int8.self, capacity: MemoryLayout.size(ofValue: int.bigEndian)) { value in
    ...
    func testParseInt32() {
        ...
        for int in testInts {
            ...
            let convertedInt: Int32 = withUnsafeMutablePointer(to: &bigEndian) {
                $0.withMemoryRebound(to: Int8.self, capacity: MemoryLayout.size(ofValue: copy)) { value in
...
//            ("ffaa2a39dbeb0a80", "1234-05-21 12:13:14.000".postgreSQLParsedDate), // this one is failing for some reason
        ]
...
//            ("c216804b02980000", "1234-05-21 12:13:14.000".postgreSQLParsedDate), // this one is failing for some reason
        ]
